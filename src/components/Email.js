            ...
            <Card.Body>
              ...
              <Form onSubmit={handleOnSubmit}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="text" id="from_name" name="from_name" placeholder="Your name..." required />
                </Form.Group>
                <Form.Group className="mb-3">
                  <Form.Label htmlFor="from_email">E-mail</Form.Label>
                  <Form.Control type="email" id="from_email" name="from_email" placeholder="Your email..." required />
                </Form.Group>
                <Form.Group className="mb-3">
                  <Form.Label htmlFor="message">Message</Form.Label>
                  <Form.Control as="textarea" id="message" name="message" placeholder="Your message..." rows={8} required />
                </Form.Group>
